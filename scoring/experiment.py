...
class ExperimentConfig:
    ...
    device: str = "auto"
    """Device for inference: 'auto' (default), 'cuda', 'cuda:N' or 'cpu'.
    'auto' resolves to CUDA when present, else CPU. (MLX was removed; see
...
class BiasExperiment(ABC):
    ...
    def load_model(self) -> None:
        ...
        ``self.model`` is the raw Hugging Face model;
